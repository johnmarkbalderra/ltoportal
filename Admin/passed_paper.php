...
if ($user_id && $vehicle_id) {
    ...
    if ($user) {
        ...
        echo "<img src='path-to-image-file.jpg' alt='image'>";
        echo "</div>";
...
<head>
    ...
    <title>Passed Pollution Test Certificate</title>
    <style>
        body {
    ...
    <!--<div class="container">
        ...
        <div class="info">
            <div class="info-left">
                ...
                <p><?= htmlspecialchars($user['plate_number']) ?></p>
                <p><?= htmlspecialchars($user['motor_vehicle_file_number']) ?></p>
                <p><?= htmlspecialchars($user['engine_number']) ?></p>
                <p><?= htmlspecialchars($user['chassis_number']) ?></p>
                <p><?= date('Y-m-d H:i:s') ?></p>
            </div>
            <div class="info-right">
                <p><?= htmlspecialchars($user['vehicle_fuel']) ?></p>
                <p><?= htmlspecialchars($user['vehicle_brand']) ?></p>
                <p><?= htmlspecialchars($user['body_type']) ?></p>
                <p>-</p>
                <p>PRIVATE</p>
            </div>
        </div>
        ...
        <div class="info">
            <div class="info-left">
                ...
                <p><strong><?= date('Y-m-d', strtotime('+1 year')) ?></strong></p>
            </div>
            <div class="info-right">
